...
public abstract class TWAConnector {
    ...
    protected WebClient getConnector(HostConfiguration hostConfiguration, EndpointConfiguration endpointConfiguration) {
        ...
        HttpClient httpClient = HttpClient.create()
                ...
                .doOnConnected(conn -> conn
                        ...
                        .addHandler(new WriteTimeoutHandler(endpointConfiguration.getResponseTimeout(),
