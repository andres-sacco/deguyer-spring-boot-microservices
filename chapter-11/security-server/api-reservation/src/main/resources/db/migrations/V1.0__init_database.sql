...
create table reservation (id bigint not null auto_increment, reservation_id bigint, itinerary_id varchar(100) not null, search_id varchar(100) not null, primary key (id));
