...
public interface ReservationRepository extends CrudRepository<Reservation, Long> {
    ...
    @Query(
            "SELECT r FROM Reservation r where r.itineraryId = :itineraryId and r.searchId = :searchId")
    List<Reservation> retrieveByItineraryIdAndSearchId(
            @Param("itineraryId") String itineraryId, @Param("searchId") String searchId);
}
