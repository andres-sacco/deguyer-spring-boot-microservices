...
public class CacheSettings {
    ...
    public static final CacheSettings DEFAULT_CACHE_SETTINGS =
            new CacheSettings(DEFAULT_REFRESH_AFTER, DEFAULT_EXPIRE_AFTER, DEFAULT_MAX_SIZE);

    public CacheSettings() {}

    public CacheSettings(
            Integer refreshAfterWriteTime, Integer expireAfterWriteTime, Integer maxSize) {
    ...
    public boolean areValid() {
        return expireAfterWriteTime > refreshAfterWriteTime;
    }
